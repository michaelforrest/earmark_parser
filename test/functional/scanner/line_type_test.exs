defmodule Functional.Scanner.LineTypeTest do
  ...
  [
    ...
    { "<pre>",             %Line.Html{tag: "pre"} },
    { "<pre class='123'>", %Line.Html{tag: "pre"} },
    { "</pre>",            %Line.Text{content: "</pre>"} },
    { "   </pre>",            %Line.Text{indent: 3, content: "</pre>"} },

    { "<pre>a</pre>",      %Line.Html{tag: "pre"} },

    { "<area>",              %Line.Html{tag: "area"} },
    { "<area/>",             %Line.Html{tag: "area"} },
    { "<area class='a'>",    %Line.Html{tag: "area"} },

    { "<br>",              %Line.Html{tag: "br"} },
    { "<br/>",             %Line.Html{tag: "br"} },
    { "<br class='a'>",    %Line.Html{tag: "br"} },

    { "<hr />",              %Line.Html{tag: "hr"} },
    { "<hr/>",             %Line.Html{tag: "hr"} },
    { "<hr class='a'>",    %Line.Html{tag: "hr"} },

    { "<img>",              %Line.Html{tag: "img"} },
    { "<img/>",             %Line.Html{tag: "img"} },
    { "<img class='a'>",    %Line.Html{tag: "img"} },

    { "<wbr>",              %Line.Html{tag: "wbr"} },
    { "<wbr/>",             %Line.Html{tag: "wbr"} },
    { "<wbr class='a'>",    %Line.Html{tag: "wbr"} },

    { "<h2>Headline</h2>",               %Line.Html{tag: "h2"} },
    { "<h2 id='headline'>Headline</h2>", %Line.Html{tag: "h2"} },

    { "<h3>Headline",               %Line.Html{tag: "h3"} },
